...
public class MediaGenres
{
    ...
    public static List<String> getAudioGenres()
    {
        List<String> audiogenres = Arrays.asList("Blues", "Classic Rock", "Country", "Dance", "Disco",
                "Funk", "Grunge", "Hip-Hop", "Jazz", "Metal", "New Age", "Oldies", "Other", "Pop", "R&B", "Rap", "Reggae",
                "Rock", "Techno", "Industrial", "Alternative", "Ska", "Death Metal", "Pranks", "Soundtrack", "Euro-Techno",
        ...
        return audiogenres.stream()
                .sorted(Comparator.naturalOrder())
                .collect(Collectors.toList());
    }
    
    public static List<String> getVideoGenres()
    {
        List<String> videogenres = Arrays.asList("Action", "Adult", "Adventure", "Animation", "Anime",
                "Biopic", "Childrens", "Comedy", "Crime", "Documentary", "Drama", "Horror", "Family", "Fantasy",
                "Historical", "Medical", "Musical", "Paranormal", "Romance", "Sport", "Science fiction", "Talk Show",
                "Thriller", "War", "Western");
        
        return videogenres.stream()
                .sorted()
                .collect(Collectors.toList());
    }
}